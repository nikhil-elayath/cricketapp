				...
				<div className="secNavParent">
					<div className="top-div-of-match">
						<div className="short-summary-with-result">
							...
							<span style={{ fontSize: "15px", fontWeight: "500" }}>{this.props.match.team_winner} {this.props.match.won_by}</span>
							<div className="Team-data">
								<div className="Team-img" style={{
									backgroundImage: `url(${india})`
								}}></div>
								<div className="Team-name" >{this.props.match.teamOne}</div>
								<div className="Team-score"> {this.props.match.teamOneScore}/{this.props.match.teamone_wicket}  ({this.props.match.team_one_total_over} overs)</div>
							</div>
							<div className="Team-data">
								<div className="Team-img" style={{
								...
								<div className="Team-score"> {this.props.match.teamTwoScore}/{this.props.match.teamtwo_wicket} ({this.props.match.team_two_total_over} overs)</div>
							</div>
						</div>
						<div className="short-summary-with-player-of-the-match">
							...
							<div className="short-summary-right">
								...
								<div style={{ fontSize: "20px", fontWeight: "700", margin: "30px 0 0 15px" }}>{this.props.match.player_of_the_match}</div>
								<div style={{ margin: "0 0 0 150px" }}>{this.props.match.team_winner}</div>
							</div>
						</div>

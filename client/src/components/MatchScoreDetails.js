                    ...
                    {this.props.match_score.map(match => (
                        ...
                        <div className="top-container-scorecard" style={{ marginTop: 80 + "px" }} >
                            ...
                            <div className="main-container-scorecard">
                                ...
                                <div className="extras-content" style={{ fontWeight: "500", padding: "5px" }}>
                                    <div >Extras</div>
                                    <div></div>
                                    <div> {match.extra_total.map(total => total.extra_count)} extras</div>
                                </div>

                                <div className="total-content" style={{ fontWeight: "500", padding: "5px" }}>
                                    <div>Total</div>
                                    <div></div>
                                ...
                                <div></div>
                                <div className="bowler-heading" style={{ padding: "5px", fontWeight: "500" }}>
                                    <div>Bowler</div>
                                    <div></div>
                                    <div>O</div>
                                    <div>M</div>
